    ...
    <div className="dashboard-stats">
      ...
      <div className="stats-section">
        <div
          ...
          style={{
            ...
            borderRight: "1px solid #8888881a",
          }}
        >
        ...
        <div className="stat-item" style={{  borderRight :"1px solid #8888881a" }}>
          <p className="views">Reviews</p>
          <p className="value d-flex text-center justify-content-center ">
            20{" "}
            <svg
              viewBox="0 0 24 24"
      ...
      <div className="chart-section">
        <div className="chart px-4">
          <img src={images.graphaes} class="graph grapheses" alt="Logo" />
        </div>
